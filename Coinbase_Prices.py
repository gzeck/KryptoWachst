...
f.write(str(get_ethbuy_price(my_client, currency_pair='ETH-USD'))+ '\n')
f.write(str(get_ethspot_price(my_client, currency_pair='ETH-USD'))+ '\n')
f.write(str(get_ethsell_price(my_client, currency_pair='ETH-USD'))+ '\n')
f.write(str(get_ltcbuy_price(my_client, currency_pair='LTC-USD'))+ '\n')
f.write(str(get_ltcspot_price(my_client, currency_pair='LTC-USD'))+ '\n')
f.write(str(get_ltcsell_price(my_client, currency_pair='LTC-USD'))+ '\n')
f.close()
